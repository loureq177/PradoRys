...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    charset = ...
    def render(self, data, accepted_media_type=..., renderer_context=...): # -> Any | str:
        """
    ...
    def resolve_template(self, template_names): # -> Template:
        ...
    ...
    def get_exception_template(self, response): # -> django.template.backends.django.Template | django.template.base.Template:
        ...
...
class HTMLFormRenderer(BaseRenderer):
    ...
    base_template = ...
    default_style = ...
    def render_field(self, field, parent_style): # -> str:
        ...
    
    def render(self, data, accepted_media_type=..., renderer_context=...): # -> str:
        """
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_rendered_html_form(self, data, view, method, request): # -> str | Literal[True] | None:
        """
    ...
    def render_form_for_serializer(self, serializer): # -> str | None:
        ...
    ...
    def get_filter_form(self, data, view, request): # -> str | None:
        ...
    
    def get_context(self, data, accepted_media_type, renderer_context): # -> dict[str, str | Any | list[Any] | dict[Any, Any] | bool | GenericContentForm | APISettings | None]:
        """
...
class DocumentationRenderer(BaseRenderer):
    ...
    code_style = ...
    languages = ...
    def get_context(self, data, request): # -> dict[str, Any | list[str]]:
        ...
...
class _BaseOpenAPIRenderer:
    ...
    def get_structure(self, data): # -> dict[str, str | dict[str, str | Any] | list[dict[str, Any]] | dict[Any, Any]]:
        ...

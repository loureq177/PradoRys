...
class APIView(View):
    ...
    def get_parser_context(self, http_request): # -> dict[str, Self | Any | tuple[()] | dict[Any, Any]]:
        """
    ...
    def get_renderer_context(self): # -> dict[str, Self | Any | tuple[()] | dict[Any, Any] | None]:
        """
    ...
    def get_exception_handler_context(self): # -> dict[str, Self | Any | tuple[()] | dict[Any, Any] | None]:
        """
    ...
    def get_exception_handler(self): # -> Any | list[Any] | dict[str, None] | bool | int | dict[str, str] | list[str] | str | None:
        """
